...
export function SocialIcons({ className = "flex gap-2" }: SocialIconsProps) {
  const socials = [
    ...
    {
      name: 'Instagram',
      href: 'https://www.instagram.com/intelliwavve/',
      color: '#E4405F',
      hoverColor: '#C13584',
      svg: (
        <svg viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4">
    ...
    {
      name: 'YouTube',
      href: 'https://www.youtube.com/@intelliwavve',
      color: '#FF0000',
      hoverColor: '#CC0000',
      svg: (
        <svg viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4">
    ...
    {
      name: 'LinkedIn',
      href: 'https://www.linkedin.com/company/intelliwavve',
      color: '#0A66C2',
      hoverColor: '#004182',
      svg: (
        <svg viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4">
    ...
    {
      name: 'TikTok',
      href: 'https://www.tiktok.com/@intelliwavve254companyke',
      color: '#000000',
      hoverColor: '#333333',
      svg: (
        <svg viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4">
