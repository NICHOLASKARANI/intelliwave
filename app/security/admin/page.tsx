...
import {
  Shield, Activity, AlertTriangle, XCircle,
  Users, Trash2, Key, LogOut, RefreshCw,
  Lock, Eye, EyeOff, Loader2, Server
} from 'lucide-react'
      ...
      <main className="max-w-7xl mx-auto p-4 lg:p-6 space-y-6">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          ...
          <div className="p-4 rounded-2xl bg-white/5 border border-white/10">
            ...
            <p className="text-2xl font-bold text-red-400">{events.filter((e: any) => e.severity === 'CRITICAL').length}</p>
