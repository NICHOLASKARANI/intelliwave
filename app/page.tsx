      ...
      <section className="relative min-h-screen flex items-center bg-gradient-to-br from-neutral-950 via-indigo-950 to-neutral-950">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-32 relative">
          <div className="text-center max-w-4xl mx-auto">
            ...
            {/* ANIMATED STATS - These WILL count up when scrolled into view */}
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            >
              ...
              >
                <div className="text-3xl md:text-4xl font-bold text-white">
                  <AnimatedCounter end={450000} suffix="+" duration={2500} />
                </div>
              ...
              >
                ...
                <div className="text-sm text-neutral-400 mt-2">Countries</div>
              </motion.div>
              ...
              >
                ...
                <div className="text-sm text-neutral-400 mt-2">AI Engineers</div>
              </motion.div>
              ...
              >
                ...
                <div className="text-sm text-neutral-400 mt-2">Projects Delivered</div>
              </motion.div>
            </motion.div>
