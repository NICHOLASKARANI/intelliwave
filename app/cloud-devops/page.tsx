...
import { Cloud, Server, Container, GitBranch, ArrowRight, CheckCircle } from 'lucide-react'

export const metadata: Metadata = {
  title: 'Cloud & DevOps Services - Infrastructure Automation & Deployment',
  description: 'Cloud infrastructure, DevOps automation, CI/CD pipelines, and managed hosting. AWS, Azure, GCP certified.',
}
...
const services = [
  {
    ...
    description: 'AWS, Azure, and GCP architecture with auto-scaling, load balancing, and disaster recovery.',
  },
  {
    icon: Container,
    title: 'Containerization',
    description: 'Docker and Kubernetes orchestration for scalable, portable deployments.',
  },
  {
    icon: GitBranch,
    title: 'CI/CD Pipelines',
    description: 'Automated testing, building, and deployment with GitHub Actions and Jenkins.',
  },
  {
    icon: Server,
    title: 'Managed Hosting',
    description: 'Fully managed cloud hosting with 99.99% uptime SLA and 24/7 monitoring.',
  },
]
      ...
      <div className="container">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center mb-24">
          ...
          <div className="relative aspect-[4/3] rounded-2xl overflow-hidden border shadow-2xl">
            ...
            <div className="absolute bottom-0 left-0 right-0 p-6">
              <p className="text-white font-semibold text-lg">Cloud Infrastructure & Automation</p>
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-24">
          {services.map((item) => {
            ...
            return (
              <div key={item.title} className="p-8 rounded-2xl border hover:border-cyan-300 dark:hover:border-cyan-800 transition-all">
