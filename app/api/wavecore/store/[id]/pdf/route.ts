...
export async function GET(
  ...
  try {
    ...
    const stockValue = sellingPrice * stockLevel
    ...
    <div class="field"><span class="label">Cost Price</span><span class="value">KSh ${Number(product.costPrice || 0).toLocaleString()}</span></div>
    <div class="field"><span class="label">Selling Price</span><span class="value">KSh ${sellingPrice.toLocaleString()}</span></div>
    <div class="field"><span class="label">Stock</span><span class="value">${stockLevel}</span></div>
