...
export async function GET(request: NextRequest) {
  ...
  } catch (error: any) { return NextResponse.json({ checks: [] }) }
}
...
export async function POST(request: NextRequest) {
  try {
    ...
    const result = await pool.query(
      'INSERT INTO "QualityCheck" (id, "workOrder", result, "organizationId", "createdAt") VALUES (gen_random_uuid()::text, $1, $2, $3, NOW()) RETURNING id',
