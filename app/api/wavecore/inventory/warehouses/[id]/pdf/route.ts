...
export async function GET(
  ...
  try {
    ...
    const html = '<!DOCTYPE html><html><head><title>Warehouse - ' + wh.name + '</title>' +
      ...
      '</style></head><body>' +
      '<div class="header"><div class="company">WaveCore ERP</div><div class="title">Warehouse Report</div></div>' +
      '<div class="name">' + wh.name + '</div>' +
      '<div class="grid">' +
      '<div class="card"><div class="label">Code</div><div class="value">' + (wh.code || 'N/A') + '</div></div>' +
      '<div class="card"><div class="label">Address</div><div class="value" style="font-size:16px">' + (wh.address || 'N/A') + '</div></div>' +
