...
import { 
  ...
  Receipt, TrendingUp, DollarSign, Clock, AlertCircle,
  ArrowUpRight
} from 'lucide-react'
import { Button } from '@/components/ui/button'

export const metadata: Metadata = {
  title: 'Accounts Receivable - WaveCore ERP | IntelliWavve',
  description: 'Manage customer invoices, payments, and receivables.',
}

const arKpis = [
  { label: 'Outstanding Receivables', value: 'KSh 0.00', icon: DollarSign, color: 'text-orange-500' },
  { label: 'Overdue Invoices', value: '0', icon: AlertCircle, color: 'text-red-500' },
  { label: 'Average Days to Pay', value: '0 days', icon: Clock, color: 'text-blue-500' },
  { label: 'Collection Rate', value: '0%', icon: TrendingUp, color: 'text-green-500' },
]
    ...
    <div className="min-h-screen bg-neutral-50 dark:bg-neutral-950">
      ...
      <div className="flex">
        <aside className="w-64 bg-white dark:bg-neutral-900 border-r min-h-[calc(100vh-64px)] p-4 hidden lg:block">
          ...
          <p className="px-4 text-[11px] font-semibold text-muted-foreground uppercase tracking-widest mb-3">Receivables</p>
          <nav className="space-y-1">
            {[
              { icon: Receipt, label: 'All Invoices', href: '/wavecore-erp/finance/ar', active: true },
              { icon: DollarSign, label: 'Record Payment', href: '/wavecore-erp/finance/ar/payments' },
              { icon: TrendingUp, label: 'Aging Report', href: '/wavecore-erp/finance/ar/aging' },
            ].map((item) => {
        ...
        <main className="flex-1 p-4 lg:p-8">
          <div className="flex items-center justify-between mb-8">
            <div>
              <h1 className="text-3xl font-bold text-neutral-900 dark:text-white">Accounts Receivable</h1>
          ...
          <div className="bg-white dark:bg-neutral-900 rounded-2xl border overflow-hidden shadow-sm">
            <div className="flex items-center justify-between p-4 border-b">
              <h2 className="font-bold">Customer Invoices</h2>
            ...
            <div className="p-12 text-center text-muted-foreground">
              ...
              <p className="font-medium">No customer invoices yet</p>
              <p className="text-sm mt-1">Create your first invoice to begin tracking receivables.</p>
