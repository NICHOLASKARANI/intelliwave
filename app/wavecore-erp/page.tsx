...
const modules = [
  ...
  { icon: Workflow, title: 'Workflow Automation', desc: 'Visual Workflow Builder, Approval Chains, Business Rules', href: '/wavecore-erp/automation', status: 'active', color: 'from-amber-500 to-orange-500', bg: 'bg-amber-50 dark:bg-amber-950', submodules: ['Workflows', 'Approvals', 'Rules', 'Triggers'] },
  { icon: Globe, title: 'Website & Commerce', desc: 'Website Builder, CMS, E-Commerce, Product Pages, Checkout', href: '/wavecore-erp/website', status: 'active', color: 'from-sky-500 to-blue-500', bg: 'bg-sky-50 dark:bg-sky-950', submodules: ['Website', 'CMS', 'E-Commerce', 'Checkout'] },
