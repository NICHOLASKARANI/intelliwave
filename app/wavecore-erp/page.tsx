...
const modules = [
  ...
  { icon: Bot, title: 'AI Copilot', desc: 'Natural Language Queries, AI Business Assistant, Smart Insights', href: '/wavecore-erp/ai', status: 'coming', color: 'from-rose-500 to-pink-500', bg: 'bg-rose-50 dark:bg-rose-950', submodules: ['AI Assistant', 'Smart Search', 'Predictions'] },
