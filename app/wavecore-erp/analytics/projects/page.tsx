...
import { Factory, Download, Loader2 } from 'lucide-react'
...
export default function projectsPage() {
  ...
  const handleDownloadPDF = () => {
    const content = ['WaveCore ERP - Projects', '='.repeat(50), 'Count: ' + (stats.projects || 0), '', '(c) 2026 IntelliWavve'].join('\n')
      ...
      <main className="max-w-4xl mx-auto p-4 lg:p-8">
        <div className="rounded-3xl bg-gradient-to-br from-pink-600 to-rose-700 p-6 mb-8">
          <div className="flex justify-between items-center">
            <h1 className="text-2xl font-bold text-white flex items-center gap-2"><Factory className="w-7 h-7" /> Projects</h1>
        ...
        {loading ? <Loader2 className="w-8 h-8 animate-spin mx-auto" /> : (
          <div className="p-6 rounded-2xl border bg-white dark:bg-neutral-900 text-center">
            <p className="text-4xl font-extrabold">{stats.projects || 0}</p>
