...
import { 
  ...
  Users, Inbox, Star, Loader2, MessageSquare, Zap, BarChart3
} from 'lucide-react'
    ...
    <div className="min-h-screen bg-neutral-50 dark:bg-neutral-950">
      ...
      <main className="max-w-7xl mx-auto p-4 lg:p-8">
        ...
        <div className="rounded-3xl bg-gradient-to-br from-pink-600 via-rose-600 to-red-600 p-6 lg:p-8 mb-8">
          ...
          <p className="text-white/80 text-sm">Tickets • SLA Management • Customer Support</p>
        </div>
        ...
        {loading ? (
          ...
          <>
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 mb-8">
              <KPICard label="Total Tickets" value={stats.total} icon={Inbox} color="text-blue-500" />
              ...
              <KPICard label="High Priority" value={stats.high} icon={Star} color="text-amber-500" />
            </div>
            ...
            {filtered.length > 0 ? (
              <div className="bg-white dark:bg-neutral-900 rounded-2xl border overflow-hidden">
                <table className="w-full text-sm">
                  <thead><tr className="border-b bg-neutral-50 dark:bg-neutral-800">
                    ...
                    <th className="text-center p-4">Messages</th>
                  </tr></thead>
                  <tbody>
                    {filtered.map(t => (
                      <tr key={t.id} className="border-b hover:bg-neutral-50 dark:hover:bg-neutral-800">
                        ...
                        <td className="p-4"><span className={`px-2 py-1 text-xs rounded-full ${priorityColors[t.priority] || 'bg-gray-50 text-gray-600'}`}>{t.priority}</span></td>
                        <td className="p-4"><span className={`px-2 py-1 text-xs rounded-full ${statusColors[t.status] || 'bg-gray-50 text-gray-600'}`}>{t.status}</span></td>
              ...
              <div className="text-center py-16 bg-white dark:bg-neutral-900 rounded-2xl border">
                ...
                <Link href="/wavecore-erp/helpdesk/tickets/create" className="inline-block mt-4">
