        ...
        <div className="rounded-3xl bg-gradient-to-br from-orange-600 via-amber-600 to-yellow-600 p-6 lg:p-8 mb-8 relative overflow-hidden">
          ...
          <div className="relative flex justify-between items-center">
            <div>
              ...
              <p className="text-white/80 text-sm">Products • Warehouses • Stock • Movements</p>
            </div>
        ...
        {loading ? (
          ...
          <>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
              <div className="p-6 rounded-2xl border bg-white dark:bg-neutral-900 hover:shadow-lg transition-all">
              ...
              <div className="p-6 rounded-2xl border bg-white dark:bg-neutral-900 hover:shadow-lg transition-all">
                ...
                <p className="text-3xl font-extrabold">KSh {(data.stockValue || 0).toLocaleString()}</p>
