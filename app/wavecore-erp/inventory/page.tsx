...
export default function InventoryPage() {
  ...
  const [qualityForm, setQualityForm] = useState({ productId: '', inspectionType: 'INCOMING', status: 'PENDING', sampleSize: '', defectCount: '', notes: '' })
  const [cycleCountForm, setCycleCountForm] = useState({ productId: '', countedQuantity: '', countedBy: '', notes: '' })
  const [returnForm, setReturnForm] = useState({ productId: '', quantity: '', returnReason: '', customerName: '', disposition: 'PENDING' })
  const [approvalForm, setApprovalForm] = useState({ approvalType: 'STOCK_ADJUSTMENT', entityType: 'PRODUCT', entityId: '', requestedQuantity: '', requestedValue: '', notes: '' })
