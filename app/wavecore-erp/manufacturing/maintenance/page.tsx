...
export default function MaintenancePage() {
  ...
  const handleAdd = () => {
    if (!assetName) return
    setRequests([{ id: Date.now().toString(), assetName, description, priority, status: 'REQUESTED', date: new Date().toISOString() }, ...requests])
    setShowAdd(false); setAssetName(''); setDescription('')
  }
