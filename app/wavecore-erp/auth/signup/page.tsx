...
import { Mail, Lock, Phone, Eye, EyeOff, Loader2, Shield, Globe, Zap, ArrowRight, User, CheckCircle, Building2, Sparkles, Server, Clock, BadgeCheck } from 'lucide-react'
        ...
        {success ? (
          ...
          <div className="bg-slate-900/80 backdrop-blur-xl rounded-3xl p-8 border border-slate-700/50 shadow-2xl">
            ...
            <div className="space-y-4">
              ...
              <div>
                <div className="relative">
                  ...
                  <input type={showPassword ? 'text' : 'password'} value={password} onChange={(e) => handlePasswordChange(e.target.value)}
            ...
            <div className="mt-6 text-center space-y-3">
              <Link href="/wavecore-erp/auth/forgot-password" className="text-sm text-blue-400 hover:text-blue-300 block">
                Forgot Password?
              </Link>
